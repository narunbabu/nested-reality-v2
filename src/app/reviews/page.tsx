    ...
    <div className="max-w-5xl mx-auto px-6 py-24 space-y-16">
      ...
      <section className="space-y-8">
        <div className="border-b border-stone-300 pb-4">
          <h2 className="text-3xl font-serif text-stone-900">AI-Generated Analysis</h2>
          <p className="text-sm text-stone-500 mt-2">
            Comprehensive reviews exploring Nested Reality from multiple perspectives
          </p>
        </div>
      ...
      <section className="space-y-8">
        <div className="border-b border-stone-300 pb-4">
          <h2 className="text-3xl font-serif text-stone-900">Human Reviews</h2>
          <p className="text-sm text-stone-500 mt-2">
            Reader testimonials and community reflections
          </p>
        </div>
          ...
          <div className="space-y-12">
            {loading ? (
              ...
              <div className="text-center py-12 text-stone-500">
                <p className="text-lg mb-2">No human reviews yet</p>
