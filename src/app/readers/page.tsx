        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100">
              Track your reading journey and connect with fellow readers
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="mt-8 bg-white rounded-lg shadow-md p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Community Reading Stats</h3>
              <p className="text-gray-600 mb-4">
                See how other readers are progressing through the book. These statistics help us understand
                which chapters resonate most with our community and where readers might need additional support.
              </p>
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-800">
                  <strong>💡 Tip:</strong> Engage with fellow readers in the comments section of essays and reviews.
                  Share your insights, ask questions, and build connections with others on the same journey!
                </p>
              </div>
            </div>
          </div>
